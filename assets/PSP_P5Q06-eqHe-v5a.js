import{_ as i}from"./CodeTutorial-CTBTP7mH.js";import{c as e,o,e as t,d as n}from"./index-DTgFY_sd.js";const l={code:`index1 = 0
index2 = 0
...
while index1 < input1:
    ...
    index1 = index1 + 1`,steps:[{explanation:"<p><strong>Question:</strong> What is the following program intended to do?</p>"},{explanation:"<p><strong>Step 1:</strong> Examine each line in order of execution and identify its function. This is how the computer thinks!</p>"},{explanation:`
            ...
            `,boxes:[{title:"Output",values:["Enter an integer: "]}]},{explanation:`
            <p>...and 5 as our second input.</p>
            `,boxes:[{title:"Output",values:["Enter an integer: 3","Enter another integer: "]}]},{explanation:`
            <p>The program prints 3 lines of 5 '#' characters each.</p>
            `,boxes:[{title:"Output",values:["Enter an integer: 3","Enter another integer: 5","#####","#####","#####"]}]}]},s={class:"container mx-auto p-4 max-w-[1024px]"},h={__name:"PSP_P5Q06",setup(d){return(c,a)=>(o(),e("div",s,[t(i,{tutorial:n(l),language:"python"},null,8,["tutorial"])]))}};export{h as default};
