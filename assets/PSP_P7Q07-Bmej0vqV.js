import{_ as e}from"./CodeTutorial-CTBTP7mH.js";import{c as t,o,e as a,d as n}from"./index-DTgFY_sd.js";const s={code:"",steps:[{info2:"<p><strong>Question:</strong> Write a function called <code>generate_password()</code> that creates and returns a random password consisting of ASCIl letters. The function should accept the desired length of the password as an integer parameter.</p>",explanation:`
...
print ('Your new password is:', new_password)
            ...
            <p>The <code>new_password</code> is then displayed to the screen.</p>
            <p>Note that in our example, there is also a second function call - this time with a parameter of value 8. Let's take a look at what happens when we run this program a few times.</p>
            `,boxes:[{title:"Output",values:["Your new password is: RMyyY","Your new password is: XQkqMZRT"]}]},{explanation:`
            <p>The <code>new_password</code> is then displayed to the screen.</p>
            <p>Note that in our example, there is also a second function call - this time with a parameter of value 8. Let's take a look at what happens when we run this program a few times.</p>
            `,boxes:[{title:"Output",values:["Your new password is: RMyyY","Your new password is: XQkqMZRT","Your new password is: bAIPR","Your new password is: cDvTEzmK"]}]},{explanation:`
            ...
            `,boxes:[{title:"Output",values:["Your new password is: RMyyY","Your new password is: XQkqMZRT","Your new password is: bAIPR","Your new password is: cDvTEzmK","Your new password is: lRaYJ","Your new password is: yRrUFkjg"]}]}]},i={class:"container mx-auto p-4 max-w-[1024px]"},h={__name:"PSP_P7Q07",setup(d){return(r,c)=>(o(),t("div",i,[a(e,{tutorial:n(s),language:"python","code-width":"w-[60%]","data-boxes-width":"w-[40%]"},null,8,["tutorial"])]))}};export{h as default};
