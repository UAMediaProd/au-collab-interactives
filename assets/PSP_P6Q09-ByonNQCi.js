import{_ as t}from"./CodeTutorial-Caw1ob4y.js";import{c as i,o as e,e as o,d as a}from"./index-BLVN1l5H.js";const s={code:`list1 = ['a', 1, 'b', 2]
list2 = []
...
print(list1)
print(list2)`,steps:[{explanation:"<p><strong>Question:</strong> What is the following program intended to do?</p>"},{explanation:`<p><strong>Question:</strong> What is the following program intended to do?</p>
            ...
            `,boxes:[{title:"Output",values:["['a', 1, 'b', 2]","['a', '1', 'b', '2']"]}]}]},l={class:"container mx-auto p-4 max-w-[1024px]"},p={__name:"PSP_P6Q09",setup(n){return(d,c)=>(e(),i("div",l,[o(t,{tutorial:a(s),language:"python"},null,8,["tutorial"])]))}};export{p as default};
