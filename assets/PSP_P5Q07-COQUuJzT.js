import{_ as e}from"./CodeTutorial-CTBTP7mH.js";import{c as o,o as i,e as t,d as a}from"./index-DTgFY_sd.js";const n={code:`>>>
Pizza Menu:
===========
1. Margherita
2. Hawaiian
...
`,steps:[{explanation:`<p><strong>Validation Loops</strong></p>
            ...
            <p>Let's look at an example of a simple menu system.</p>`},{explanation:`<p><strong>Validation Loops</strong></p>
            <p>Another common usage of loops is for the validation of user input - we sometimes call these 'Validation loops'.</p>
            <p>Validation loops serve to restrict the set of acceptable user responses. This is achieved by preventing the program from continuing until the user input is 'valid'.</p>
...
Thank you for your order!`},{explanation:"<p><strong>Question:</strong> Write code for the Pizza Menu program to restrict the user input to only options on the menu (1, 2 or 3).</p>"},{explanation:`
...
print("\\nThank you for your order!")
        `,language:"python"},{explanation:`
            <p>How do we construct a validation loop?</p>
            <p><strong>"while the user input is invalid, keep asking them to try again".</strong></p>`},{explanation:`
...
print("\\nThank you for your order!")
        `,highlightLines:[8,9,10,11,12]},{explanation:`
            <p>This has two parts:</p>
            <ol>
                <li>A <code>while</code> loop with a condition that is true if the user input is <strong>invalid</strong>.</li>
...
print("\\nThank you for your order!")
        `,highlightLines:[13]},{explanation:`
            ...
            `,highlightLines:[8,9,10,11,12]},{explanation:`<pre class="inline-pre"><code class="language-python">>>> user_input = 6
>>> user_input != 1
True
>>> user_input != 2
True
...
True</code></pre>
            ...
            `,highlightLines:[8,9,10,11,12]},{explanation:`<pre class="inline-pre"><code class="language-python">>>> user_input = 2
>>> user_input != 1
True
>>> user_input != 2
True
...
True</code></pre>
            ...
            `}]},s={class:"container mx-auto p-4 max-w-[1024px]"},c={__name:"PSP_P5Q07",setup(p){return(r,l)=>(i(),o("div",s,[t(e,{tutorial:a(n),language:"python-repl","show-boxes":!1},null,8,["tutorial"])]))}};export{c as default};
