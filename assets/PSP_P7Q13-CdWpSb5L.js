import{_ as e}from"./CodeTutorial-CTBTP7mH.js";import{c as t,o as i,e as o,d as n}from"./index-DTgFY_sd.js";const c={code:`def my_function(number):
    new_list = []
    index = 2
    while index < number:
        if number%index == 0:
...
print(my_function(29))`,explanation:`
            ...
            `,boxes:[{title:"Output",values:[]}]},{explanation:`
            <p>Let's take a look at the output!</p>
            `,boxes:[{title:"Output",values:["[3, 5]","[2, 3, 6, 8, 12]","[]"]}]}]},d={class:"container mx-auto p-4 max-w-[1024px]"},m={__name:"PSP_P7Q13",setup(a){return(l,s)=>(i(),t("div",d,[o(e,{tutorial:n(c),language:"python"},null,8,["tutorial"])]))}};export{m as default};
