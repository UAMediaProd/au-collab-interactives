import{_ as e}from"./CodeTutorial-CTBTP7mH.js";import{c as o,o as n,e as t,d as r}from"./index-DTgFY_sd.js";const s={code:"",steps:[{explanation:`<p>In the problems explored so far, we have used loops iteratively - that is, to execute a specific number of times.</p>
...
`,highlightChars:[{line:14,match:"user_choice"},{line:16,match:"user_choice == 'y':"}]},{explanation:`
...
`,highlightChars:[{line:16,match:"user_choice == 'y':"},{line:20,match:"user_choice"}]},{explanation:`
...
print('\\nThank you for using PSP Password Generator!')`,highlightLines:[10,11,12,22]},{explanation:`
...
>>>`}]},a={class:"container mx-auto p-4 max-w-[1024px]"},c={__name:"PSP_P7Q08",setup(i){return(p,d)=>(n(),o("div",a,[t(e,{tutorial:r(s),language:"python","show-boxes":!1},null,8,["tutorial"])]))}};export{c as default};
