import{_ as e}from"./CodeTutorial-CyR3wzRq.js";import{c as o,o as t,e as i,d as a}from"./index-D1h9s9Qj.js";const s={code:"asdfasdf",steps:[{info2:`<p><strong>Question:</strong></p>
...
comp_choice = random.choice(['share', 'steal'])`,highlightLines:[0,1,2],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
print("You chose:\\t", user_choice, "\\nComputer chose:\\t", comp_choice)`,highlightLines:[4],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
print("You chose:\\t", user_choice, "\\nComputer chose:\\t", comp_choice)`,highlightLines:[2,3],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
if user_choice == 'share' and comp_choice == 'share':
    comp_score += 2
    user_score += 2
    print("\\nYou both gain 2 coins.")`,highlightLines:[10,11,12,13],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
if user_choice == 'share' and comp_choice == 'share':
    ...
    comp_score += 3
    user_score -=1
    print("\\nComputer gains 3 coins, you lose 1!")`,highlightLines:[14,15,16,17],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
if user_choice == 'share' and comp_choice == 'share':
    ...
    comp_score -=1
    user_score += 3
    print("\\nYou gain 3 coins, computer loses 1!")`,highlightLines:[18,19,20,21],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
if user_choice == 'share' and comp_choice == 'share':
    ...
    print("\\nYou both chose to steal! Nobody gets anything.")`,highlightLines:[22,23],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
print("\\nComp Score:", comp_score)`,highlightLines:[24,25],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
turn_counter += 1`,highlightLines:[5,11,29],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
if comp_score > user_score:
    ...
    print("\\nDraw - No Winner!")`,highlightLines:[31,32,33,34,35,36],info:`
            <div class="flowchart-outline">
                <p>Control loop</p>
                <p style="font-size:0.8rem">Play again [y/n]</p>
                <div class="flowchart-outline">
...
while play_again == 'y':
    ...
    play_again = input("\\nWould you like to play again? [y/n]: ")`,highlightLines:[2,3,40],info:`
            <div class="flowchart-outline">
...
while play_again == 'y':
    ...
    play_again = input("\\nWould you like to play again? [y/n]: ")`,highlightLines:[11,12]},{explanation:`
            ...
            `,code:`>>>
Enter your choice, "share" or "steal": `},{explanation:`
...
Would you like to play again? [y/n] `},{explanation:`
...
Would you like to play again? [y/n] n
>>>`}]},c={class:"container mx-auto p-4 max-w-[1024px]"},p={__name:"PSP_P6Q10",setup(r){return(l,n)=>(t(),o("div",c,[i(e,{tutorial:a(s),language:"python","code-width":"w-[70%]","data-boxes-width":"w-[30%]"},null,8,["tutorial"])]))}};export{p as default};
