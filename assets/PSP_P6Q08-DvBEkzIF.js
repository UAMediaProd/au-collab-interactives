import{_ as o}from"./CodeTutorial-CTBTP7mH.js";import{c as e,o as t,e as i,d as s}from"./index-DTgFY_sd.js";const a={code:`menu = [
    'Lamb steak', 
    'Tomato soup', 
    'Fried rice', 
    'Pumpkin soup', 
...
`,highlightLines:[15]},{explanation:`
            ...
            <div class="flowchart-connection">🡇</div>
            <div class="flowchart-solid">✅ Randomly select and display a 'Soup of the day'</div>`},{explanation:`
            <p>Let's run it 4 more times...</p>
            `,boxes:[{title:"Output",values:["Soup of the day: Tomato soup"]}]},{explanation:`
            <p>Let's run it 3 more times...</p>
            `,boxes:[{title:"Output",values:["Soup of the day: Tomato soup","Soup of the day: Pumpkin soup"]}]},{explanation:`
            <p>Let's run it 2 more times...</p>
            `,boxes:[{title:"Output",values:["Soup of the day: Tomato soup","Soup of the day: Pumpkin soup","Soup of the day: Tomato soup"]}]},{explanation:`
            <p>Let's run it 1 more time...</p>
            `,boxes:[{title:"Output",values:["Soup of the day: Tomato soup","Soup of the day: Pumpkin soup","Soup of the day: Tomato soup","Soup of the day: Pea soup"]}]},{explanation:`
            <p>The program works as expected!</p>
            `,boxes:[{title:"Output",values:["Soup of the day: Tomato soup","Soup of the day: Pumpkin soup","Soup of the day: Tomato soup","Soup of the day: Pea soup","Soup of the day: Pea soup"]}]}]},d={class:"container mx-auto p-4 max-w-[1024px]"},h={__name:"PSP_P6Q08",setup(n){return(l,c)=>(t(),e("div",d,[i(o,{tutorial:s(a),language:"python","code-width":"w-[60%]","data-boxes-width":"w-[40%]"},null,8,["tutorial"])]))}};export{h as default};
