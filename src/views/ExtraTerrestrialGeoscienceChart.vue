                            ...
                            <g>
                                ...
                                <transition name="fade">
                                    <g v-show="visibility.quartz" class="quartz">
                                        <path class="cls-2 bedload" :class="glow.bedload ? 'glow' : ''"
                                        ...
                                        <path class="cls-2 suspended" :class="glow.suspended ? 'glow' : ''"
                                            d="M187.4,252.7c21.7-27.8,44-55.3,73.9-74,8.1-5.1,16.7-9.3,25.3-13.5,32-15.7,61.8-29.6,94.4-44.1" />
                                        <path class="cls-2 washload" :class="glow.washload ? 'glow' : ''"
...
.basalt .glow {
    filter: drop-shadow(0px 0px 3px #ed1c24cc)
}

.organics .glow {
    filter: drop-shadow(0px 0px 3px #09892acc)
}

.water .glow {
    filter: drop-shadow(0px 0px 3px #1448ffcc)
}
