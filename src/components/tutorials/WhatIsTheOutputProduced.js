...
print(new_variable)`,
  steps: [
    {
      lineNumber: 1,
      explanation: "<p>In this set of slides, we will outline a systematic approach for solving problems of the sort where a block of code is given and you are asked to figure out what output it will generate.</p><p>First, lets specify the approach. Then, we’ll go through a few examples and apply it properly. Lets begin. ​</p>",
      highlightLines: [],
    },
    {
      lineNumber: 0,
    ...
    {
      lineNumber: 0,
      explanation: "<p><strong>Take note of any variable assignments in the current line. Write them down.</strong></p><p>Keep a piece of scrap paper handy. Each time you process a line of code, write down any new variables introduced in that line, or any changes to an existing variable. This is to keep an account of the current state of computer memory.</p>",
      highlightLines: [],
      boxes: [
        {
          title: "Memory",
      ...
      boxes: [
        {
          title: "Memory",
          useHtml: true,
          values: { "new_variable": '<del>25</del> <span>10</span>', "another_variable": 30 }
        }
      ]
    },
    {
