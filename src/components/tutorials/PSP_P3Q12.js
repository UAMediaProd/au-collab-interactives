...
print(display)`,
    steps: [
        ...
        {
            explanation: `<p>Getting input from the user.</p>
        ...
        {
            explanation: `<p>This line creates a new string by repeating the dash character <code>"-"</code> a number of times equal to the value of <code>x</code>.</p>
        ...
        {
            explanation: `<p>Finally, we display the result to the screen.</p>`,
            highlightLines: [2],
            info: `
            <div class="flowchart-solid">Obtain an integer as input from the user (<code>x</code>)</div>
            <div class="flowchart-connection">🡇</div>
        ...
        {
            explanation: `<p>This program prompts for an integer from the user, and displays that number of dashes "-" to the screen.</p>`,
            info: `
            <div class="flowchart-solid">Obtain an integer as input from the user (<code>x</code>)</div>
            <div class="flowchart-connection">🡇</div>
            <div class="flowchart-solid">Create a string (<code>display</code>) consisting of <code>x</code> dashes</div>
        ...
        {
            explanation: `<p>Let's trace through the program execution. We'll use 8 as our test input.</p>`,
            boxes: [
                {
                    title: "Memory"
                },
        ...
        {
            explanation: `<p>Prompt the user for a number and assign it to <code>x</code>.</p>
        ...
        {
            explanation: `<p>Create a string by repeating the dash character <code>x</code> times.</p>
        ...
        {
            explanation: `<p>Display the value of <code>display</code> to the screen.</p>`,
            highlightLines: [2],
            boxes: [
                {
                    title: "Memory",
