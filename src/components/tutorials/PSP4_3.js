...
print('\\n\\nThe End!')`,
  steps: [
    ...
    {
      lineNumber: 2,
      explanation: "<p>We initialise the <code>index</code> variable to <code>0</code>. This will be used to access each character in the string, starting from position 0.</p>",
      highlightLines: [2],
      boxes: [
        {
          title: "Memory",
