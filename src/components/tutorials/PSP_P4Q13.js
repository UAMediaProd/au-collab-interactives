            ...
            boxes: [
                {
                    ...
                    values: {
                        ...
                        "output_string": { value: "''", highlight: true }
                    },
                    connections: [
            ...
            boxes: [
                {
                    ...
                    values: {
                        "index": { value: "0" },
                        "output_string": { value: "''" },
                        "user_input": { value: "'beautiful'", highlight: true }
                    },
                    connections: [
                        { from: "index", toKey: "index" },
                        { from: "output_string", toKey: "output_string" },
            ...
            boxes: [
                {
                    ...
                    values: {
                        "index": { value: "0" },
                        "output_string": { value: "'b'", highlight: true },
                        "user_input": { value: "'beautiful'" },
                        "char": { value: "'b'" }
                    },
                    connections: [
            ...
            boxes: [
                {
                    ...
                    values: {
                        "index": { value: "4" },
                        "output_string": { value: "'bt'", highlight: true },
                        "user_input": { value: "'beautiful'" },
                        "char": { value: "'t'" }
                    },
                    connections: [
            ...
            boxes: [
                {
                    ...
                    values: {
                        "index": { value: "6" },
                        "output_string": { value: "'btf'", highlight: true },
                        "user_input": { value: "'beautiful'" },
                        "char": { value: "'f'" }
                    },
                    connections: [
            ...
            boxes: [
                {
                    title: "Memory",
                    values: {
                        "index": { value: "7", highlight: true },
                        "output_string": { value: "'btf'" },
                        "user_input": { value: "'beautiful'" },
                        "char": { value: "'f'" }
                    },
                    connections: [
            ...
            boxes: [
                {
                    ...
                    values: {
                        "index": { value: "8" },
                        "output_string": { value: "'btfl'", highlight: true },
                        "user_input": { value: "'beautiful'" },
                        "char": { value: "'l'" }
                    },
                    connections: [
